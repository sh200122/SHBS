import { A, APP, BEHAVIORS, BODY, CATCHMOVE, CATCH_VIEW, CHANGE, CLASS, CLICK_VIEW, COMMENT, COMPILE_MODE, CONFIRM, CONTAINER, CONTEXT_ACTIONS, CURRENT_TARGET, CUSTOM_WRAPPER, Current, DATASET, DATE, DOCUMENT_ELEMENT_NAME, DOCUMENT_FRAGMENT, EVENT_CALLBACK_RESULT, EXTERNAL_CLASSES, FOCUS, FormElement, HEAD, HOOKS_APP_ID, HTML, History, ID, INPUT, KEY_CODE, Location, MutationObserver, OBJECT, ON_HIDE, ON_LOAD, ON_READY, ON_SHOW, OPTIONS, PAGE_INIT, PROPERTY_THRESHOLD, PROPS, PURE_VIEW, ROOT_STR, SET_DATA, SET_TIMEOUT, STATIC_VIEW, STYLE, SVGElement, Style, TARGET, TARO_RUNTIME, TIME_STAMP, TOUCHMOVE, TYPE, TaroElement, TaroEvent, TaroNode, TaroRootElement, TaroText, TaroURLProvider, UID, URLSearchParams, VALUE, VIEW, _caf, _raf, addLeadingSlash, convertNumber2PX, createComponentConfig, createEvent, createPageConfig, createRecursiveComponentConfig, customWrapperCache, debounce, env, eventCenter, eventHandler, eventSource, extend, getComponentsAlias, getCurrentInstance, getCurrentPage, getHomePage, getOnHideEventKey, getOnReadyEventKey, getOnShowEventKey, getPageInstance, getPath, handlePolyfill, hasBasename, hydrate, incrementId, init_dist, injectPageInstance, isComment, isElement, isHasExtractProp, isParentBinded, isText, nav, nextTick, now, options, parseUrl, perf, removePageInstance, safeExecute, shortcutAttr, stringify, stripBasename, stripSuffix, stripTrailing, taroDocumentProvider, taroGetComputedStyleProvider, taroHistoryProvider, taroLocationProvider, taroWindowProvider, throttle } from "./chunk-R3CD5KEQ.js";
import { Events, hooks } from "./chunk-IEBZOLZA.js";
