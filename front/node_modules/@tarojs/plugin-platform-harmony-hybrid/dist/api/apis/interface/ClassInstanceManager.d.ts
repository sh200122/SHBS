declare class ClassInstanceManager {
    private static INSTANCE;
    private classIdMap;
    constructor();
    static getInstance(): ClassInstanceManager;
    createInstance(className: string, option?: any): number;
    ...
    destroyInstance(className: string, objectId: number): void;
}
