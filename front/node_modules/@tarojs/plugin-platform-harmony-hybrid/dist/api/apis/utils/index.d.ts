...
declare function shouldBeFunction(target: unknown): {
    flag: boolean;
    msg?: undefined;
} | {
    flag: boolean;
...
export { shouldBeObject, shouldBeFunction, findDOM, getParameterError, inlineStyle, setTransform, serializeParams, temporarilyNotSupport, weixinCorpSupport, permanentlyNotSupport, processOpenApi, getCurrentPath };
