 ...
 */
const chooseMedia = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { count = 9, mediaType = ['video', 'image'], sourceType = ['album', 'camera'], maxDuration = 10, sizeType = ['original', 'compressed'], camera = 'back', success, fail, } = options;
