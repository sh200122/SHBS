...
class Checkbox {
  ...
  render() {
    ...
    return (hAsync(Host, { className: 'weui-cells_checkbox' }, hAsync("input", Object.assign({ ref: dom => {
        if (!dom)
          return;
        this.inputEl = dom;
        if (this.id)
...
class Radio {
  ...
  render() {
    ...
    return (hAsync(Host, { className: 'weui-cells_checkbox', onClick: this.handleClick }, hAsync("input", Object.assign({ ref: dom => {
        if (!dom)
          return;
        this.inputEl = dom;
        if (this.id)
...
const indexCss$9 = "taro-scroll-view-core{-webkit-overflow-scrolling:touch;width:100%;display:block}taro-scroll-view-core::-webkit-scrollbar{display:none}.taro-scroll-view__scroll-x{overflow:scroll hidden}.taro-scroll-view__scroll-y{overflow:hidden scroll}";
...
const indexCss$3 = "taro-textarea-core{width:300px;display:block}taro-textarea-core .auto-height{height:auto}.taro-textarea{height:inherit;appearance:none;cursor:auto;border:0;width:100%;line-height:1.5;display:block;position:relative}.taro-textarea:focus{outline:none}";
