...
class TaroMiniPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.watchRun.tapAsync(PLUGIN_NAME, this.tryAsync((compiler) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (changedFiles && (changedFiles === null || changedFiles === void 0 ? void 0 : changedFiles.size) > 0) {
                this.isWatch = true;
            }
            yield this.run(compiler);
    ...
    adjustConfigContent(config) {
        ...
        for (const [key, value] of Object.entries(usingComponents)) {
            ...
            if (!compPath.includes(helper_1.NODE_MODULES))
                return;
            const match = compPath.replace(helper_1.NODE_MODULES, 'npm').match(/npm.*/);
    ...
    generateIndependentMiniFiles(compilation, compiler) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.pages.forEach(page => {
                let importBaseTemplatePath = (0, helper_1.promoteRelativePath)(node_path_1.default.relative(page.path, node_path_1.default.join(sourceDir, this.getTemplatePath(baseTemplateName))));
                ...
                this.independentPackages.forEach(({ pages }, name) => {
                    ...
                    if (pages.includes(page.path) && name === childName) {
                        ...
                        importBaseTemplatePath = (0, helper_1.promoteRelativePath)(node_path_1.default.relative(page.path, node_path_1.default.join(sourceDir, name, this.getTemplatePath(baseTemplateName))));
                    }
                });
                if (!isIndependent)
                    return;
    ...
    generateMiniFiles(compilation, compiler) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isBuildPlugin) {
                const pluginJSONPath = node_path_1.default.join(sourceDir, 'plugin', 'plugin.json');
