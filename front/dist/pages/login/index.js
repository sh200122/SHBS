...
function Login(_ref) {
        ...
        success: async res => {
          if (res.code) {
            ...
            if (response.data.success) {
              // 保存 token 和用户信息
              (0,_utils_auth__WEBPACK_IMPORTED_MODULE_2__.setToken)(response.data.token);
              (0,_utils_auth__WEBPACK_IMPORTED_MODULE_2__.setUserId)(response.data.user._id);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.View, {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_tarojs_components__WEBPACK_IMPORTED_MODULE_4__.Button, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(taro_ui__WEBPACK_IMPORTED_MODULE_1__.AtIcon, {
        prefixClass: "at-icon",
        value: "weixin",
        size: "24",
        color: "#ffffff",
